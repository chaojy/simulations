...
(In above, there is no input list, only an output list)
...
Now try to put all of this in a process
Use rerun functions, map functions, mutate functions - the idea is 4 sample sizes, run simulation 100x for each sample size
...
What if I looked at a binomial distribution??  Could repeat using binomial distribution
